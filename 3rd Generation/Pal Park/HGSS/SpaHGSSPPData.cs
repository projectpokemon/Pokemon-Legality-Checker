...
{
	public class SpaHGSSPPData : HGSSPPData
	{
		private static readonly string m_Slot1 = "00,00,00,00,42,00,00,00,00,00,00,00,84,15,0D,02,E0,FF";
		private static readonly string m_Slot2 = "02-03,00,00,00,00-FF,75-7A,28,02,00-FF,C1-C2,27,02,FD,17,07,02,00,00";
